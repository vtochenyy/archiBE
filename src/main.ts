...
import { TypeOfFoodIntakeRepository } from "./dish/typeOfFoodIntake.repository";
...
function bindDeps(): void {
  ...
  appContainer.bind<BaseRepository>(TYPES.TypeOfDishRepository).to(TypeOfDishRepository).inSingletonScope();
  appContainer.bind<BaseRepository>(TYPES.TypeOfFoodIntakesRepository).to(TypeOfFoodIntakeRepository).inSingletonScope();
  ...
  appContainer.bind<BaseRepository>(TYPES.GlobalMenuRepository).to(GlobalMenuRepository).inSingletonScope();
  ...
  appContainer.bind<BaseRepository>(TYPES.DishToGlobalMenuRepository).to(DishToGlobalMenuRepository).inSingletonScope();
  ...
  appContainer.bind<BaseRepository>(TYPES.TableRepository).to(TableRepository).inSingletonScope();
  ...
  appContainer.bind<SaveResponseInLogsMiddleware>(TYPES.SaveResponseInLogsMiddleware).to(SaveResponseInLogsMiddleware).inSingletonScope();
}
